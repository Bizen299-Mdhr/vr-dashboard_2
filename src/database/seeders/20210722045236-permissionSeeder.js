...
module.exports = {
    up: async (queryInterface) => {
        await queryInterface.sequelize.query('TRUNCATE permissions RESTART IDENTITY');
            ...
            if (Object.prototype.hasOwnProperty.call(permissions, key)) {
                ...
                for (let moduleKey in permissionmodules) {
                    if (Object.prototype.hasOwnProperty.call(permissionmodules, moduleKey)) {
                        ...
                        let existingPermission = await permission.findOne({where: {slug: permissionData.slug}});
